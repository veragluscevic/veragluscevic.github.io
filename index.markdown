...
I am a member of three science collaborations focused on precision measurements of the CMB: [Simons Observatory](https://simonsobservatory.org/), [CMB-S4](https://cmb-s4.org/) and [ACT](https://en.wikipedia.org/wiki/Atacama_Cosmology_Telescope). I also collaborate with the LSST Dark Matter group and have co-led the Likelihood and Theory analysis group for the Simons Observatory. I have previously served on the Science Council for CMB-S4 and have led the Dark Matter working group for the collaboration.
